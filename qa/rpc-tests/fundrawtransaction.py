...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid masternodescheguevara address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid masternodescheguevara address" in e.error['message'])
