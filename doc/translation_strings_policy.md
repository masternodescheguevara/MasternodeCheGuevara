...
This document provides guidelines for internationalization of the masternodescheguevara Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `masternodescheguevara_en.ts` remains unchanged.
