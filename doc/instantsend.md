...
This mechanism has been integrated into Bitcore-Node-masternodescheguevara which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/masternodescheguevarapay/insight-api-masternodescheguevara#web-socket-api](https://github.com/masternodescheguevarapay/insight-api-masternodescheguevara#web-socket-api)
* API: [https://github.com/masternodescheguevarapay/insight-api-masternodescheguevara#instantsend-transactions](https://github.com/masternodescheguevarapay/insight-api-masternodescheguevara#instantsend-transactions)
...
By default, the masternodescheguevara Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the masternodescheguevara Core daemon:
