...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all masternodescheguevara related functionality
...
/*
    ...
    allow endless transaction that would bloat masternodescheguevara and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("masternodescheguevara-ps-server");
