    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  masternodescheguevara-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the masternodescheguevara in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MCG, 0.1 MCG, 1 MCG and 10 MCG -- sort of like the paper money you use every day.</li> \
