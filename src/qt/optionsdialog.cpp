    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MCG-light"), QVariant("light"));
    ui->theme->addItem(QString("MCG-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MCG-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("MCG-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("MCG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MCG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MCG-traditional"), QVariant("trad"));
