...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print masternodescheguevara address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "masternodescheguevara",               "masternode",             &masternode,             true,  {} },
    { "masternodescheguevara",               "masternodelist",         &masternodelist,         true,  {} },
    { "masternodescheguevara",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "masternodescheguevara",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "masternodescheguevara",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "masternodescheguevara",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
