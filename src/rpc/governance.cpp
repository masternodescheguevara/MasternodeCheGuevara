...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in masternodescheguevara.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("masternodescheguevara.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "masternodescheguevara",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "masternodescheguevara",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "masternodescheguevara",               "gobject",                &gobject,                true,  {} },
    { "masternodescheguevara",               "voteraw",                &voteraw,                true,  {} },
