...
2. run masternodescheguevarad with -printalert or -sendalert like this:
   /path/to/masternodescheguevarad -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.masternodescheguevara.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/masternodescheguevara Core:0.12.0.58/"));
